...
kable(
  rbind("Marginal Standardization (bootstrap CI)" = as.numeric(marg_stand_res),
        "IP Weighting (robust CI)" = as.numeric(ip_weighted_res),
        "IP Weighting (bootstrap CI)" = as.numeric(ip_weighted_boot)),
