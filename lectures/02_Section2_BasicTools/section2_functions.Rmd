...
The `.Random.seed` object contains information on three important things. The first element in the list contains information on the type of seed being used. There are several to choose from, but the default in R is an updated version of the Mersenne-Twister known as the "Inversion" method. The number 10403 is referring to this. 
