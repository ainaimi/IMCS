...
Here, we'll use another example to illustrate the concept of simulation in a slightly more familiar setting. Suppose we have a dataset that contains information on the body mass index of 200 individuals sampled from the general population. We assume this BMI variable is distributed normally. 
...
## Inverse Probability Weighting versus G Computation in Time-Dependent Settings
...
## Heterogeneous Treatment Effects in the Presence of Null Overall Effects
