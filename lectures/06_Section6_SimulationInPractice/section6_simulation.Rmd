...
In this first worked example, we are going to pull together several of the pieces that we've covered over the last few days. We'll use the ADEMP framework to develop a simulation study we'll conduct here; two more examples (a randomized trial and a mediation analysis) will follow.
