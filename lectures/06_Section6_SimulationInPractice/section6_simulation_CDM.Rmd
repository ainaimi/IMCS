---
title: "Simulation Study: Example 3"
...
- Evaluate the bias of a CDM estimator when we include the exposure induced mediator outcome confounder ($L$) in a simple regression model
- Evaluate the bias of a CDM estimator when we fail to adjust for the exposure induced mediator outcome confounder
